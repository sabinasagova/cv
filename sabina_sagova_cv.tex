    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item \textbf{Coursework:} Database Systems, Principles of Data Organization, Programming in Java language, Graph Algorithms, Digital Image Processing, Introduction to Computer Linguistics
            \end{highlights}
        \end{onecolentry}
